...
PROMPTS = [
    ...
    (
        "Product",
        "Write a one-sentence product description for a SaaS analytics platform that helps sales teams track pipeline metrics.",
    ),
    ("Code", "Write a Python function is_prime(n) that returns True if n is prime."),
    (
        "Reasoning",
        "A bat and ball cost $1.10 together. The bat costs $1 more than the ball. How much does the ball cost? Show your reasoning.",
    ),
]
...
if __name__ == "__main__":
    ...
    if tq_only:
        ...
        baseline = {
            ...
            "prompts": [
                ...
                {"label": "Math", "tokens": 13, "time_s": 0.79, "tok_s": 16.0, "response": "17 * 23 = **391**"},
                {
                    "label": "Product",
                    "tokens": 22,
                    "time_s": 1.32,
    ...
    if baseline and tqplus:
        ...
        print(
            f"Memory: {baseline['memory_mib']} MiB → {tqplus['memory_mib']} MiB "
